...
rst=stmt.executeQuery("select productname,productprice,quantity,charity,productid from product where productname='"+pname+"' ");
  ...
  <table width="568" border="1" align="center">
    ...
    <tr>
      ...
      <td><p align="right">card holder Email
          <input type="text" name="chname" value="<%= session.getAttribute("customer") %>" readonly="true"/>
      </p>
