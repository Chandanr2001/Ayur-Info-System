...
var x=document.forms["form3"]["t2"].value;
var y=document.forms["form3"]["t3"].value;

var a=document.forms["form3"]["t4"].value;
var b=document.forms["form3"]["t5"].value;

var d=document.forms["form3"]["t6"].value;
var e=document.forms["form3"]["t7"].value;
var f=document.forms["form3"]["t8"].value;
var g=document.forms["form3"]["t9"].value;
...
<body>
<div align="center" class="style1">Add Shop </div>
<form id="form1" name="form1" method="get" action="AddShop.jsp">
  <table width="374" height="10" border="1" align="center">
    <tr>
      <td width="163"><p align="right" class="style11">Shop Name</p></td>
...
String pincode=request.getParameter("t7");
String state=request.getParameter("t8");
String address=request.getParameter("t9");
String question=request.getParameter("question");
int x=stmt.executeUpdate("insert into shop(shopname,password,first,last,country,pincode,state,address) values('"+shopname+"','"+password+"','"+first+"','"+last+"','"+country+"','"+pincode+"','"+state+"','"+address+"')");
