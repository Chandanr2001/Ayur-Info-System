...
<p align="center">Herbal Details</p>
<div >
<form  method="post" action=""   >
  <table bgcolor="grey" width="637" border="0" align="center" style="border-radius:20px">
    <tr >
      <td width="276"><div align="right" class="style3">Enter Herbal name </div></td>
      <td width="189"><input name="s1" type="text" id="s1"  /></td>
    </tr>
    <tr>
      <td><div align="right" class="style3">Scientific name </div></td>
    ...
    <tr>
      <td><div align="right" class="style3">available at </div></td>
...
int x=stmt.executeUpdate("insert into herbals(name,scientificname,usefullness,available,description) values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"')");
if(x!=0){

out.print("New herbals added Successfully");
}
}catch(Exception e){
...
rst=stmt.executeQuery("select * from herbals ");
  ...
  <tr bgcolor="#0000FF">
    ...
    <td><div align="center" class="style2">Scientific name  </div></td>
    <td><div align="center" class="style2">Usefullness</div></td>
    <td><div align="center" class="style2">Available at </div></td>
