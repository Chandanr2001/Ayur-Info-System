...
rst=stmt.executeQuery("select * from shop ");
  ...
  <tr bgcolor="#0000FF">
    ...
    <td><div align="center" class="style1">Shopname </div></td>
	...
	<td><div align="center" class="style1">Pin Code</div></td>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><div align="center"><%= rst.getString(9) %></div></td>
