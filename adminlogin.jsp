...
<%
 ...
 %>
  ...
  <tr>
   <td width="603" height="416"><div class="w3-content w3-section" style="max-width:500px"  > <img class="mySlides w3-animate-top" src="images/1.jpg" style="width:100%" /> <img class="mySlides w3-animate-bottom" src="images/2.jpg" style="width:100%" /> <img class="mySlides w3-animate-top" src="images/3.jpg" style="width:100%" /> </div></td>
    <td width="572"><center>
...
<h3 align="center" style="color:#CCCCCC">Login Page</h3>
  <form id="form1" name="form1" method="post" action="">
							  <table style="background:#CCCCCC; border-radius:20px;" width="379" border="0" align="center">
								<tr>
								  <td width="182"><div align="right" class="style2">Email</div></td>
								  <td width="512"><input name="username" type="text" required/></td>
								</tr>
								<tr>
