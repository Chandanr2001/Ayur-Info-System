...
if(rst.next()){
session.setAttribute("customer",s1);
%>
<script>

alert("login Successfull");
window.open("buy2.jsp","_self");
</script>
<%
}else{
%>
...
<h3 align="center" style="color:#CCCCCC">User Login </h3>
  <form id="form1" name="form1" method="post" action="">
							  <table style="background:#CCCCCC; border-radius:20px;" width="704" border="0" align="center">
								<tr>
								  ...
								  <td>&nbsp;</td>
								  <td width="512"><input name="username" type="text" /></td>
								</tr>
								<tr>
								  <td>&nbsp;</td>
		...
		<!-- <i class="fa fa-eye-slash"></i> -->
								...
								<a style="color:#000099;" href="AddCustomer.jsp" >New Customer Registration</a><br />

								  <a style="color:#000099;" href="fergot.jsp" target="_blank" >Forgot Password</a>								 </td>
								</tr>
    </table>
